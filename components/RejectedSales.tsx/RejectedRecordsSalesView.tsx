...
} from '@/types' // Changed import source for SalesLine and VivoSalesHeader
...
export default function RejectedRecordsSalesView({ No, username }: Props) {
  ...
  return (
    <DialogContent className="sm:max-w-[95vw] max-h-[95vh] p-0 flex flex-col overflow-hidden">
      ...
      <DialogHeader className="px-4 py-3 border-b">
        <DialogTitle>Rejected Sale #{No}</DialogTitle>
        <DialogDescription>
          Details of the rejected sales record. This view is read-only.
        </DialogDescription>
      </DialogHeader>
                ...
                {lineItems.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={11} className="text-center text-muted-foreground">
                      No line items found for this rejected sale.
                    </TableCell>
                  </TableRow>
                ) : (
