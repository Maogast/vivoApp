...
export function RejectedSalesList({ data, username }: Props) {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-medium text-xl text-gray-800">Rejected Sales</h2>
      </div>
          ...
          <TableBody>
            ...
            {filteredData.length === 0 && (
              <TableRow>
                ...
                >
                  No rejected sales found matching your filters. 😔
                </TableCell>
              </TableRow>
            )}
